...
export const STYLES: StyleDef[] = [
    {
        ...
        accentColor2: "#fbbf24",
        cornerStyle: "bracket",
        description: "Professional cinematic portrait, natural human facial features, realistic skin texture, soft cinematic key lighting, subtle rim light, controlled highlights, elegant shadows, sophisticated neutral color palette, subtle 35mm film grain, premium editorial photography, polished professional appearance, realistic eyes, refined details, cinematic depth, high-end magazine portrait.",
    },
    {
        id: "editorial-ink",
        label: "Editorial Ink",
    ...
    },
    {
        ...
        accentColor2: "#a3e635",
        cornerStyle: "feather",
        description: "Elegant editorial watercolor portrait, refined natural facial features, delicate watercolor washes, subtle paper grain, soft controlled brush strokes, warm neutral skin tones, muted sophisticated palette, graceful transitions, premium fashion editorial illustration, artistic professional portrait, subtle handcrafted texture.",
    },
    {
        id: "film-noir",
        label: "Film Noir",
    ...
    },
    {
        ...
        accentColor2: "#94a3b8",
        cornerStyle: "sketch",
        description: "Professional graphite portrait drawing, realistic human facial proportions, delicate pencil linework, refined graphite shading, subtle cross-hatching, natural facial details, fine paper texture, elegant monochrome tonal range, sophisticated hand-drawn portrait, premium editorial illustration.",
    },
    {
        id: "soft-3d",
        label: "Soft 3D",
        ...
        accentColor2: "#a78bfa",
        cornerStyle: "bracket",
        description: "Premium stylized 3D portrait, realistic human proportions, expressive natural eyes, sophisticated facial features, smooth cinematic rendering, subtle skin shading, elegant studio lighting, realistic hair detail, refined materials, premium animated-film quality, professional editorial character portrait.",
    },
    {
        id: "cyber-editorial",
        label: "Cyber Editorial",
        shortcut: "7",
        accentColor: "#06b6d4",
        accentColor2: "#a855f7",
        cornerStyle: "glitch",
        description: "Premium futuristic editorial portrait, realistic human facial features, sophisticated dark environment, subtle cyan and magenta rim lighting, refined futuristic details, clean geometric accents, controlled neon highlights, cinematic contrast, professional technology magazine aesthetic, polished high-end portrait.",
    },
    {
        id: "vintage-film",
        label: "Vintage Film",
        ...
        accentColor2: "#f59e0b",
        cornerStyle: "bracket",
        description: "Premium vintage 35mm film portrait, realistic natural facial features, subtle analog grain, soft muted colors, gentle highlight rolloff, refined shadows, authentic photographic texture, elegant nostalgic atmosphere, sophisticated editorial photography, professional film aesthetic.",
    },
];
